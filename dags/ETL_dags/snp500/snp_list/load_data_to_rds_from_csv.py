...
def load_snp_list_data_to_rds_from_csv(task_logger):
    ...
    try:
        ...
        load_snp500_to_rds_from_csv.install_aws_s3_extension()
    ...
    try:
        ...
        # )
        load_snp500_to_rds_from_csv.table_import_from_local(schema, table)
